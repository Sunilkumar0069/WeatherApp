...
// @dart = 2.12
import 'WindDetailsBO.dart' as x0 show WindDetailsBO;
...
final windDetailsBoGeneratedAdapter = JsonMapperAdapter(
  title: 'myweather',
  url: 'package:myweather/BO/WindDetailsBO/WindDetailsBO.dart',
  reflectableData: null,
  memberSymbolMap: null,
  valueDecorators: {
    typeOf<List<x0.WindDetailsBO>>(): (value) => value.cast<x0.WindDetailsBO>(),
    typeOf<Set<x0.WindDetailsBO>>(): (value) => value.cast<x0.WindDetailsBO>()
},
  enumValues: {
...
JsonMapper initializeJsonMapper({Iterable<JsonMapperAdapter> adapters = const [], SerializationOptions? serializationOptions, DeserializationOptions? deserializationOptions}) {
  ...
  JsonMapper.enumerateAdapters([...adapters, windDetailsBoGeneratedAdapter], (JsonMapperAdapter adapter) {
